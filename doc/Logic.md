...
| ------------- | ------------------------------------- | --------------- | ------------------------------- |
| **knowledge** | universal / no spacetime anchor       | server TruthSet | *anumana* (inference)           |
| **news**      | bound to a specific place and/or time | session-only    | *pratyaksa* (direct perception) |
...
* **non(a)** = 1 $-$ 2|a| -- non-affirming negation. Measures epistemic openness: how much certainty room remains. Full certainty in either direction ($\pm$1) yields $-$1 (fully closed); ignorance (0) yields +1 (fully open). See `doc/Non.md` for the Buddhist philosophical motivation.
